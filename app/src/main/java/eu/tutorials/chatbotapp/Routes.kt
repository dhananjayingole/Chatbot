...
object Routes {
    const val BotScreen = "botscreen"
    const val AdminScreen = "adminscreen"
    const val ChatScreen = "chatscreen"
    const val PdfListScreen = "pdflistscreen"
    const val AdminLoginScreen = "adminloginscreen"
    ...
    const val PendingApprovalsScreen = "pendingapprovalscreen"
}